...
public class CustomProductAdapter extends ArrayAdapter<CustomProduct> {
    private LayoutInflater mInflater;

    public CustomProductAdapter(Context context, ArrayList<CustomProduct> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.horizontal_product_item_relative, parent, false);
