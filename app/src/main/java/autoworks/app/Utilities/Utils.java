...
public class Utils {
    ...
    ////if cannot get phone number, please visit this link: http://stackoverflow.com/questions/5134398/telephonymanager-getline1number-failing
    public static String getPhoneNumber() {
        TelephonyManager tMgr = (TelephonyManager) AutoWorksApplication.autoWorksApplication.getSystemService(Context.TELEPHONY_SERVICE);
        String mPhoneNumber = tMgr.getLine1Number();
        String getSimSerialNumber = tMgr.getSimSerialNumber();
        return mPhoneNumber;
    }
    public static String getSimSerialNumber() {
        TelephonyManager telemamanger = (TelephonyManager) AutoWorksApplication.autoWorksApplication.getSystemService(Context.TELEPHONY_SERVICE);
        String getSimSerialNumber = telemamanger.getSimSerialNumber();
        return getSimSerialNumber;
    }
    public static void showOKDialog(Context context, String message){
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setTitle("LeeLoo");
